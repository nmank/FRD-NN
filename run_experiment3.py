...
base_dir = '/data4/mankovic/FRD-NN/experiments/mnist/raw/cnn/rotation_augmentation/raw_triangle_nn_3layer_lr_p1/'
...
model = mm.choose_model('raw_cnn_1')
...
tm.train_model(datapath, model, data_transforms, opt, save_model_location, save_csv_location, 20, batch_size, frd_normalize = True)
