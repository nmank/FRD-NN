...
base_dir = '/data4/mankovic/FRD-NN/experiments/mnist/frd/rotation_augmentation/frd_triangle_nn_other4layer_lr_p0001/'
...
opt = optim.Adadelta(model.parameters(), lr=.0001)
